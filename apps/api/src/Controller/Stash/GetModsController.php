...
use DumpIt\StashFilter\Application\Stash\GetModsQuery;
...
#[Route('/api/mods', name: 'get_mods', methods: 'GET')]
class GetModsController extends AbstractController
{
    ...
    {
        $data = $this->queryBus->query(new GetModsQuery());
